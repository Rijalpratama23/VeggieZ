        ...
        <div className="poster p-4 md:p-10 lg:p-20">
          <div className="relative rounded-2xl overflow-hidden shadow-lg">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
              <h2 className="text-2xl sm:text-4xl md:text-6xl font-promo font-extrabold tracking-wider">
                GRAB YOUR
              </h2>
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-promo font-extrabold mt-2">
                FRESH DEALS
              </h2>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-2 sm:px-4 mt-10 mb-20 grid gap-6">
            {products.map((item) => (
              <div
                key={item.id}
                className="bg-white shadow-md rounded-2xl flex flex-col sm:flex-row items-center justify-between p-3 sm:p-6 hover:shadow-lg transition-all duration-300"
              >
                <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-1/2 text-center sm:text-left">
                  ...
                  <div>
                    ...
                    <p className="line-through text-xs sm:text-sm text-gray-400 mt-1">
                      Rp. {item.oldPrice.toLocaleString('id-ID')}/ikat
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between w-full sm:w-1/2 mt-4 sm:mt-0 gap-2 sm:gap-4 text-center sm:text-right">
                  <span className="bg-green-100 text-green-700 text-xs sm:text-sm font-semibold px-3 py-1 rounded-full self-center sm:self-auto">
